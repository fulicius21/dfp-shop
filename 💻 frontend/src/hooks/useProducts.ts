...
import { apiFallback } from '@/services/api-fallback';
...
export function useProducts(filters?: ProductFilters): UseQueryResult<Product[], Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getProducts();
...
export function useProduct(id: string): UseQueryResult<Product, Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getProduct(id);
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useFeaturedProducts(): UseQueryResult<Product[], Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getFeaturedProducts();
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useNewArrivals(): UseQueryResult<Product[], Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getNewArrivals();
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useBestsellers(): UseQueryResult<Product[], Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getBestsellers();
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useCategories(): UseQueryResult<Category[], Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getCategories();
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useCategory(slug: string): UseQueryResult<Category, Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getCategory(slug);
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useCategoryProducts(
  ...
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getProductsByCategory(slug);
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useCollections(): UseQueryResult<Collection[], Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getCollections();
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useCollection(slug: string): UseQueryResult<Collection, Error> {
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getCollection(slug);
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useCollectionProducts(
  ...
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.getProductsByCollection(slug);
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useProductSearch(
  ...
  return useQuery(
    ...
    async () => {
      const response = await apiFallback.searchProducts(query);
      return response.data;
    },
    {
      ...defaultQueryOptions,
...
export function useApiHealth() {
  return useQuery(
    ['api-health'],
    async () => {
      return await apiFallback.checkApiHealth();
    },
    {
