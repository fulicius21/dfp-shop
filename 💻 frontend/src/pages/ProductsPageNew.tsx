...
const ProductsPage: React.FC = () => {
  ...
  const filteredProducts = React.useMemo(() => {
    ...
    // Search filter (if API doesn't handle it)
    if (searchTerm && !productsUsingFallback) {
    ...
    // Sorting (if API doesn't handle it)
